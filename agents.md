...
Noted here rather than in an ADR since this isn't a decision that's been made — just a known candidate feature, kept visible for whoever picks this codebase up next. Not scheduled; no code changes exist yet for it.
