...
Noted here rather than in an ADR since neither is a decision that's been made — just a known behavior and a candidate feature, kept visible for whoever picks this codebase up next. Not scheduled; no code changes exist yet for either.
